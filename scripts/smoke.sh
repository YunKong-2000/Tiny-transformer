...
python3 -m tiny_transformer.benchmarks.model --checkpoint "$run_dir/train/last.pt" --device cpu --prompt-length 16 --new-tokens 8 --warmup 1 --repeats 3 --output "$run_dir/benchmark.json"
